...
<div class="example-set">
    ...
    <a href="{{ site.url_dummy }}" class="btn btn-default btn-base">Link as Button Base</a>
    <a href="{{ site.url_dummy }}" class="btn btn-default btn-large">Link as Button Large</a>
    <a href="{{ site.url_dummy }}" class="btn btn-default btn-small">Link as Button Small</a>
</div>
